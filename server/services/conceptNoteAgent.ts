...
STOP and wait for the user's map selection after calling this tool.`,
    {
      ...
      zoneSource: z.enum(["neighborhood_zones", "intervention_zones", "neighborhoods"]).optional().describe("For composite step 1: 'neighborhood_zones' (default) shows bairros with risk scores + vulnerability-weighted priority. 'neighborhoods' shows raw IBGE data. 'intervention_zones' uses legacy synthetic zones."),
    },
    async (args: any) => {
      pushEvent({
        type: 'open_map',
