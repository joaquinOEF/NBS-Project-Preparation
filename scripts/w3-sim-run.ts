...
await run('2 · COLETIVO ENCOSTA VIVA — sem lugar marcado, encosta',
  mkState({
    ...
    // grade-viva has no quantified benefit anywhere in the repo, so there is no
    // number to react to — the flow says so and moves straight to the timeframe.
