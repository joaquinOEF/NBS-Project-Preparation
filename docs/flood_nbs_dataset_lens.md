...
- `docs/flood_hazard_score_methodology.md`
- `docs/flood_risk_score_methodology.md`
...
| What native riparian/wetland species may be suitable? | species suitability | species occurrences, native species lists, wetland/riparian vegetation maps | supports planting palettes and restoration logic |
...
| Source | `docs/flood_hazard_score_methodology.md`, `docs/flood_risk_score_methodology.md` |
